...
public class ShopItemVO {
	...
	private String mainFile; // 상품 메인 이미지 
	...
	public String getMainRealFile() {
		return mainRealFile;
	}

	public void setMainRealFile(String mainRealFile) {
		this.mainRealFile = mainRealFile;
	}
